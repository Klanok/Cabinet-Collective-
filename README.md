...
857 tests, and the ones that matter are hand-calculated rather than snapshot:
...
| — | Keeping a grained bank's fronts together on the sheet so the grain matches | **done** |
